...
const Upcoming = () => {
  ...
  const SearchMovies = async(e)=>{
    ...
    console.log("search");
    try {
      const url = `https://api.themoviedb.org/3/search/upcoming?api_key=ab1da08307f82007e9975d4dccf67670&query=${query}`
  ...
  useEffect(()=>{
    fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=ab1da08307f82007e9975d4dccf67670&language=en-US&page=1')
    .then((res)=>res.json())
